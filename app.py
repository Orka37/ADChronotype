...
st.markdown("""
    ...
    /* 1. THE EXORCISM: Kill ALL default focus rings in Number Inputs */
    .stNumberInput * {
    ...
    /* 4. +/- Buttons: Permanent Neutral State */
    ...
    /* Force background and border to stay neutral even after click */
