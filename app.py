...
if st.session_state.page == "input":
    with st.form("input_details"):
        ...
        with col1:
            ...
            sleeptime = st.slider("**Sleep Time (24hr)**", 0, 23, value=int(st.session_state.sleeptime),step=0.5)
            waketime  = st.slider("**Wake Time (24hr)**",  0, 23, value=int(st.session_state.waketime),step=0.5)
        with col2:
