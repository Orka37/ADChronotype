...
if st.session_state.page == "input":
    with st.form("input_details"):
        ...
        with col1:
            ...
            sleeptime = st.slider("**Sleep Time (24hr)**", 0.0, 23.5, step=0.5, value=float(st.session_state.sleeptime))
            waketime  = st.slider("**Wake Time (24hr)**",  0.0, 23.5, step=0.5, value=float(st.session_state.waketime))
        with col2:
...
if st.session_state.page=="tips":
    ...
    st.info("Tips show for the factors which have a greater than 2 contribution value!")
    if st.session_state.score_chronotype > 2:
        ...
        st.markdown("<h2 style=''><b><i>---------------------------------------------------------------</i></b></h2>", unsafe_allow_html=True)
    if st.session_state.score_sleeptime > 2 or st.session_state.score_waketime > 2:
        ...
        st.markdown("<h2 style=''><b><i>---------------------------------------------------------------</i></b></h2>", unsafe_allow_html=True)
    if st.session_state.score_age > 2:
        ...
        st.markdown("<h2 style=''><b><i>---------------------------------------------------------------</i></b></h2>", unsafe_allow_html=True)
    if st.session_state.score_bmi > 2:
        ...
        st.markdown("<h2 style=''><b><i>---------------------------------------------------------------</i></b></h2>", unsafe_allow_html=True)
    if st.session_state.score_ethnicity > 2:
